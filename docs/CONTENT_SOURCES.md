...
## Dane i benchmarki używane na Home i w Perspektywie
- Boston Consulting Group, *Five Truths (and One Lie) About Corporate Transformation* (2024)
  - https://www.bcg.com/publications/2024/five-truths-and-a-lie-about-corporate-transformation
  - 26% analizowanych transformacji stworzyło wartość zarówno w krótkim, jak i długim horyzoncie.
- Boston Consulting Group, *Why Companies Get Agile Right—and Wrong* (2024)
  - https://www.bcg.com/publications/2024/why-companies-get-agile-right-wrong
  - badanie 127 firm; 94% prowadziło inicjatywy agile, 66% deklarowało udaną transformację, a 53% spełniło kryteria realnego wpływu i trwałej zmiany.
...
## Zasada dotycząca OAF
- „Organizational Architecture Framework” na tej stronie oznacza nazwę rozwijanej syntezy i języka decyzji.
- Nie publikujemy twierdzenia, że skrót OAF jest jednym powszechnie uznanym standardem branżowym.
- Autorski wkład jest formułowany jako **integracja i sposób zastosowania**: Kierunek → Architektura → Priorytety → Dowody, z pętlą zwrotną Dowody → kolejna decyzja.
- Pełny metamodel, ontologia, obiekty decyzji, prawa właścicielskie i formalny rytm decyzyjny wymagają dalszego opracowania i nie są obecnie deklarowane jako ukończony standard.
